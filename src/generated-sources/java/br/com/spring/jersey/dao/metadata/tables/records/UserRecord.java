...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record4<Integer, String, String, String> {
    ...
    private static final long serialVersionUID = 605778742;

    /**
     * Setter for <code>public.user.id_user</code>.
     */
    ...
    /**
     * Getter for <code>public.user.id_user</code>.
     */
     ...
     */
    public UserRecord(Integer idUser, String username, String name, String password) {
        super(User.USER);
